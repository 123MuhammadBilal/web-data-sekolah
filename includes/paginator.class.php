...
class Paginator
{
	...
	function __construct()
	{
		$this->current_page = 1;
		$this->mid_range = 7;
		$this->ipp_array = array(5, 10, 20, 30, 40, 50, 'All');
	...
	function paginate()
	{
		...
		if ($this->num_pages > 1) {
			...
			$this->return .= "<li class='page-item'><a class=\"page-link\" href=\"$_SERVER[PHP_SELF]?page=1&ipp=All$this->querystring\"></a></li></ul></div> \n";
		}
